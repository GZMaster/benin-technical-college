        ...
        <div className="row">
          <div className="col-md-8">
            <div className="blog-single-item">
              ...
              <div className="blog-tiltle_block">
                <h4>
                  <a href="blog-post.html">Blog Heading here One line</a>
                </h4>
                <h6>
                  <a href="#">
            ...
            <div className="blog-single-item">
              <div className="blog-img_block">
                <img
                  src="images/blog/blog-img_02.jpg"
                  className="img-fluid"
                  alt="blog-img"
                />
                <div className="blog-date">
            ...
            <div className="blog-single-item">
              <div className="blog-img_block">
                <img
                  src="images/blog/blog-img_03.jpg"
                  className="img-fluid"
                  alt="blog-img"
                />
                <div className="blog-date">
          ...
          <div className="col-md-4">
            <form>
              ...
              <button type="submit" className="btn btn-warning btn-blogsearch">
                SEARCH
              </button>
            </form>
